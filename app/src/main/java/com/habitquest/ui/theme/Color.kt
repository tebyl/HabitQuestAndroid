...
internal val DarkPalette = AppColorPalette(
	...
	cardBackground2 = Color(0xFFF1E8F7),
	divider = Color(0xFFE7DDE7),
	dividerLight = Color(0xFFDCCFE0),
	textPrimary = Color(0xFF2C2C2C),
	textSecondary = Color(0xFF4F4548),
	textMuted = Color(0xFF7A6F72),
	textDim = Color(0xFF988C8F),
	textDimmer = Color(0xFFB4A8AB),
)
